...
.. _program_listing_file_portal_engine_resources_resources_mesh_geometry.h:

Program Listing for File mesh_geometry.h
========================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_resources_resources_mesh_geometry.h>` (``portal\engine\resources\resources\mesh_geometry.h``)
