...
.. _program_listing_file_portal_engine_renderer_vulkan_descriptors_vulkan_uniform_buffer.cpp:

Program Listing for File vulkan_uniform_buffer.cpp
==================================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_renderer_vulkan_descriptors_vulkan_uniform_buffer.cpp>` (``portal\engine\renderer\vulkan\descriptors\vulkan_uniform_buffer.cpp``)
