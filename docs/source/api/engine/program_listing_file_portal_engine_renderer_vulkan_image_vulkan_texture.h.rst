...
.. _program_listing_file_portal_engine_renderer_vulkan_image_vulkan_texture.h:

Program Listing for File vulkan_texture.h
=========================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_renderer_vulkan_image_vulkan_texture.h>` (``portal\engine\renderer\vulkan\image\vulkan_texture.h``)
