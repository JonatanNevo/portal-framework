...
.. _program_listing_file_portal_engine_resources_resource_registry.cpp:

Program Listing for File resource_registry.cpp
==============================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_resources_resource_registry.cpp>` (``portal\engine\resources\resource_registry.cpp``)
