...
.. _program_listing_file_portal_engine_renderer_renderer.h:

Program Listing for File renderer.h
===================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_renderer_renderer.h>` (``portal\engine\renderer\renderer.h``)
