...
.. _program_listing_file_portal_engine_resources_loader_shader_loader.cpp:

Program Listing for File shader_loader.cpp
==========================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_resources_loader_shader_loader.cpp>` (``portal\engine\resources\loader\shader_loader.cpp``)
