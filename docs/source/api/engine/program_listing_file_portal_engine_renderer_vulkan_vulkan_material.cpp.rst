...
.. _program_listing_file_portal_engine_renderer_vulkan_vulkan_material.cpp:

Program Listing for File vulkan_material.cpp
============================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_renderer_vulkan_vulkan_material.cpp>` (``portal\engine\renderer\vulkan\vulkan_material.cpp``)
