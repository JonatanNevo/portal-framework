...
.. _program_listing_file_portal_engine_resources_resources_resource.h:

Program Listing for File resource.h
===================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_resources_resources_resource.h>` (``portal\engine\resources\resources\resource.h``)
