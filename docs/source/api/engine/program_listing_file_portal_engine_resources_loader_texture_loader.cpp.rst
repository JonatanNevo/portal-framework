...
.. _program_listing_file_portal_engine_resources_loader_texture_loader.cpp:

Program Listing for File texture_loader.cpp
===========================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_resources_loader_texture_loader.cpp>` (``portal\engine\resources\loader\texture_loader.cpp``)
