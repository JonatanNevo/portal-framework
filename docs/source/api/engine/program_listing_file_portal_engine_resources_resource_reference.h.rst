...
.. _program_listing_file_portal_engine_resources_resource_reference.h:

Program Listing for File resource_reference.h
=============================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_resources_resource_reference.h>` (``portal\engine\resources\resource_reference.h``)
