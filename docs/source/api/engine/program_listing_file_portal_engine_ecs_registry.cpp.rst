...
.. _program_listing_file_portal_engine_ecs_registry.cpp:

Program Listing for File registry.cpp
=====================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_ecs_registry.cpp>` (``portal\engine\ecs\registry.cpp``)
