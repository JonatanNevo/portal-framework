...
.. _program_listing_file_portal_engine_renderer_vulkan_vulkan_material.h:

Program Listing for File vulkan_material.h
==========================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_renderer_vulkan_vulkan_material.h>` (``portal\engine\renderer\vulkan\vulkan_material.h``)
