...
.. _program_listing_file_portal_engine_renderer_vulkan_base_vulkan_resource.h:

Program Listing for File vulkan_resource.h
==========================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_renderer_vulkan_base_vulkan_resource.h>` (``portal\engine\renderer\vulkan\base\vulkan_resource.h``)
