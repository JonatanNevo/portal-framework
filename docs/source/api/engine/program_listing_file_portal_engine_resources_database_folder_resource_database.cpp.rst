...
.. _program_listing_file_portal_engine_resources_database_folder_resource_database.cpp:

Program Listing for File folder_resource_database.cpp
=====================================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_resources_database_folder_resource_database.cpp>` (``portal\engine\resources\database\folder_resource_database.cpp``)
