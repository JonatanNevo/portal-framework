...
.. _program_listing_file_portal_engine_resources_source_file_source.cpp:

Program Listing for File file_source.cpp
========================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_resources_source_file_source.cpp>` (``portal\engine\resources\source\file_source.cpp``)
