...
.. _program_listing_file_portal_engine_renderer_shaders_shader_types.h:

Program Listing for File shader_types.h
=======================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_renderer_shaders_shader_types.h>` (``portal\engine\renderer\shaders\shader_types.h``)
