...
.. _program_listing_file_portal_engine_renderer_vulkan_allocated_buffer.cpp:

Program Listing for File allocated_buffer.cpp
=============================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_renderer_vulkan_allocated_buffer.cpp>` (``portal\engine\renderer\vulkan\allocated_buffer.cpp``)
