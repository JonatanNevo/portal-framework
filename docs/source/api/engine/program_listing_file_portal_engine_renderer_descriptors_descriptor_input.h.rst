...
.. _program_listing_file_portal_engine_renderer_descriptors_descriptor_input.h:

Program Listing for File descriptor_input.h
===========================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_renderer_descriptors_descriptor_input.h>` (``portal\engine\renderer\descriptors\descriptor_input.h``)
