...
.. _program_listing_file_portal_engine_resources_loader_material_loader.cpp:

Program Listing for File material_loader.cpp
============================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_resources_loader_material_loader.cpp>` (``portal\engine\resources\loader\material_loader.cpp``)
