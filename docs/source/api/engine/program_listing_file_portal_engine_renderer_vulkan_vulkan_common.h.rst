...
.. _program_listing_file_portal_engine_renderer_vulkan_vulkan_common.h:

Program Listing for File vulkan_common.h
========================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_renderer_vulkan_vulkan_common.h>` (``portal\engine\renderer\vulkan\vulkan_common.h``)
