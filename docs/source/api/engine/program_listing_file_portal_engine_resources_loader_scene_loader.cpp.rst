...
.. _program_listing_file_portal_engine_resources_loader_scene_loader.cpp:

Program Listing for File scene_loader.cpp
=========================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_resources_loader_scene_loader.cpp>` (``portal\engine\resources\loader\scene_loader.cpp``)
