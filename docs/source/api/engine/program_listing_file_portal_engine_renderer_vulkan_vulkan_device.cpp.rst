...
.. _program_listing_file_portal_engine_renderer_vulkan_vulkan_device.cpp:

Program Listing for File vulkan_device.cpp
==========================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_renderer_vulkan_vulkan_device.cpp>` (``portal\engine\renderer\vulkan\vulkan_device.cpp``)
