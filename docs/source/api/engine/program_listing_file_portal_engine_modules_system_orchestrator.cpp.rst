...
.. _program_listing_file_portal_engine_modules_system_orchestrator.cpp:

Program Listing for File system_orchestrator.cpp
================================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_modules_system_orchestrator.cpp>` (``portal\engine\modules\system_orchestrator.cpp``)
...
.. code-block:: cpp
   ...
   void SystemOrchestrator::set_registry(ecs::Registry& registry)
   {
