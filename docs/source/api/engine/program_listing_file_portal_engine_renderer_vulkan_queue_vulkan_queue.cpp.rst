...
.. _program_listing_file_portal_engine_renderer_vulkan_queue_vulkan_queue.cpp:

Program Listing for File vulkan_queue.cpp
=========================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_renderer_vulkan_queue_vulkan_queue.cpp>` (``portal\engine\renderer\vulkan\queue\vulkan_queue.cpp``)
