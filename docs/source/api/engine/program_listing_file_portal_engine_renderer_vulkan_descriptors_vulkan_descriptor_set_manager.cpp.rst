...
.. _program_listing_file_portal_engine_renderer_vulkan_descriptors_vulkan_descriptor_set_manager.cpp:

Program Listing for File vulkan_descriptor_set_manager.cpp
==========================================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_renderer_vulkan_descriptors_vulkan_descriptor_set_manager.cpp>` (``portal\engine\renderer\vulkan\descriptors\vulkan_descriptor_set_manager.cpp``)
       ...
       for (size_t set = properties.start_set; set < end_set; ++set)
       {
           ...
           for (auto&& [name, write_descriptor] : write_descriptor_sets)
           {
               ...
               for (size_t frame_index = 0; frame_index < frames_in_flight; ++frame_index)
                   write_descriptors_map[frame_index][set][binding] = {
                       .write_descriptor_set = write_descriptor,
