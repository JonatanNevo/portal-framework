...
.. _program_listing_file_portal_engine_renderer_vulkan_descriptors_vulkan_descriptor_set_manager.h:

Program Listing for File vulkan_descriptor_set_manager.h
========================================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_renderer_vulkan_descriptors_vulkan_descriptor_set_manager.h>` (``portal\engine\renderer\vulkan\descriptors\vulkan_descriptor_set_manager.h``)
