...
.. _program_listing_file_portal_engine_renderer_descriptor_layout_builder.cpp:

Program Listing for File descriptor_layout_builder.cpp
======================================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_renderer_descriptor_layout_builder.cpp>` (``portal\engine\renderer\descriptor_layout_builder.cpp``)
