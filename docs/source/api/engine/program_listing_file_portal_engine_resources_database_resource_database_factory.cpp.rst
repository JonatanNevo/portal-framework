...
.. _program_listing_file_portal_engine_resources_database_resource_database_factory.cpp:

Program Listing for File resource_database_factory.cpp
======================================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_resources_database_resource_database_factory.cpp>` (``portal\engine\resources\database\resource_database_factory.cpp``)
...
.. code-block:: cpp
   ...
   std::unique_ptr<ResourceDatabase> ResourceDatabaseFactory::create(ModuleStack& stack, const DatabaseDescription& description)
   {
       ...
       case DatabaseType::Folder:
           ...
           return FolderResourceDatabase::create(stack, description.path.value());
       }
