...
.. _program_listing_file_portal_engine_renderer_vulkan_debug_debug_messenger.cpp:

Program Listing for File debug_messenger.cpp
============================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_renderer_vulkan_debug_debug_messenger.cpp>` (``portal\engine\renderer\vulkan\debug\debug_messenger.cpp``)
