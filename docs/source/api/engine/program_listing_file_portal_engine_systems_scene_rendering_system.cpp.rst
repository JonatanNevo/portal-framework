...
.. _program_listing_file_portal_engine_systems_scene_rendering_system.cpp:

Program Listing for File scene_rendering_system.cpp
===================================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_systems_scene_rendering_system.cpp>` (``portal\engine\systems\scene_rendering_system.cpp``)
