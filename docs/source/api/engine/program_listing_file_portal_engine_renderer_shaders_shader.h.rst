...
.. _program_listing_file_portal_engine_renderer_shaders_shader.h:

Program Listing for File shader.h
=================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_renderer_shaders_shader.h>` (``portal\engine\renderer\shaders\shader.h``)
