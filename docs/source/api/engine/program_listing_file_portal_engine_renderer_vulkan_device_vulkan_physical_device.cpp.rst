...
.. _program_listing_file_portal_engine_renderer_vulkan_device_vulkan_physical_device.cpp:

Program Listing for File vulkan_physical_device.cpp
===================================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_renderer_vulkan_device_vulkan_physical_device.cpp>` (``portal\engine\renderer\vulkan\device\vulkan_physical_device.cpp``)
