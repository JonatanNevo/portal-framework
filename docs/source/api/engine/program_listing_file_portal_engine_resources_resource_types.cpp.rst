...
.. _program_listing_file_portal_engine_resources_resource_types.cpp:

Program Listing for File resource_types.cpp
===========================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_resources_resource_types.cpp>` (``portal\engine\resources\resource_types.cpp``)
