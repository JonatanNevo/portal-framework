...
.. _program_listing_file_portal_engine_renderer_renderer.cpp:

Program Listing for File renderer.cpp
=====================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_renderer_renderer.cpp>` (``portal\engine\renderer\renderer.cpp``)
