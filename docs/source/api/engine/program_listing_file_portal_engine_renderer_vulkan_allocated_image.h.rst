...
.. _program_listing_file_portal_engine_renderer_vulkan_allocated_image.h:

Program Listing for File allocated_image.h
==========================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_engine_renderer_vulkan_allocated_image.h>` (``portal\engine\renderer\vulkan\allocated_image.h``)
