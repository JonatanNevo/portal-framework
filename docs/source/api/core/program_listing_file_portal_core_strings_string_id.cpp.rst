...
.. _program_listing_file_portal_core_strings_string_id.cpp:

Program Listing for File string_id.cpp
======================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_core_strings_string_id.cpp>` (``portal\core\strings\string_id.cpp``)
