...
.. _program_listing_file_portal_core_files_file_system.cpp:

Program Listing for File file_system.cpp
========================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_core_files_file_system.cpp>` (``portal\core\files\file_system.cpp``)
