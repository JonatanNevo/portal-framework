...
.. _program_listing_file_portal_core_jobs_worker_queue.h:

Program Listing for File worker_queue.h
=======================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_core_jobs_worker_queue.h>` (``portal\core\jobs\worker_queue.h``)
