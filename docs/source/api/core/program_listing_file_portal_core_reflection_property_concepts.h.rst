...
.. _program_listing_file_portal_core_reflection_property_concepts.h:

Program Listing for File property_concepts.h
============================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_core_reflection_property_concepts.h>` (``portal\core\reflection\property_concepts.h``)
