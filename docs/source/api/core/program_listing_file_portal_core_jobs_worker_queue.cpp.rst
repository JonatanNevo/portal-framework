...
.. _program_listing_file_portal_core_jobs_worker_queue.cpp:

Program Listing for File worker_queue.cpp
=========================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_core_jobs_worker_queue.cpp>` (``portal\core\jobs\worker_queue.cpp``)
