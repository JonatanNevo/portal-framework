...
.. _program_listing_file_portal_core_debug_assert.h:

Program Listing for File assert.h
=================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_core_debug_assert.h>` (``portal\core\debug\assert.h``)
