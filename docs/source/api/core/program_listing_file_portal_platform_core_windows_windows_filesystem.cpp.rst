...
.. _program_listing_file_portal_platform_core_windows_windows_filesystem.cpp:

Program Listing for File windows_filesystem.cpp
===============================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_platform_core_windows_windows_filesystem.cpp>` (``portal\platform\core\windows\windows_filesystem.cpp``)
