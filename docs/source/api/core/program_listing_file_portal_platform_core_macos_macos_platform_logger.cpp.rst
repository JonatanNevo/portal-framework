...
.. _program_listing_file_portal_platform_core_macos_macos_platform_logger.cpp:

Program Listing for File macos_platform_logger.cpp
==================================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_platform_core_macos_macos_platform_logger.cpp>` (``portal\platform\core\macos\macos_platform_logger.cpp``)
