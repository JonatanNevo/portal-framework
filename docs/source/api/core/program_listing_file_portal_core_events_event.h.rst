...
.. _program_listing_file_portal_core_events_event.h:

Program Listing for File event.h
================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_core_events_event.h>` (``portal\core\events\event.h``)
