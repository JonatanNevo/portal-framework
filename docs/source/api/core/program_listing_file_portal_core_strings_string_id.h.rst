...
.. _program_listing_file_portal_core_strings_string_id.h:

Program Listing for File string_id.h
====================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_core_strings_string_id.h>` (``portal\core\strings\string_id.h``)
