...
.. _program_listing_file_portal_core_defines_preprocessor.h:

Program Listing for File preprocessor.h
=======================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_core_defines_preprocessor.h>` (``portal\core\defines\preprocessor.h``)
