...
.. _program_listing_file_portal_core_buffer_stream.cpp:

Program Listing for File buffer_stream.cpp
==========================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_core_buffer_stream.cpp>` (``portal\core\buffer_stream.cpp``)
