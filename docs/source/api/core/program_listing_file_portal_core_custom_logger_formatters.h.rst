...
.. _program_listing_file_portal_core_custom_logger_formatters.h:

Program Listing for File custom_logger_formatters.h
===================================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_core_custom_logger_formatters.h>` (``portal\core\custom_logger_formatters.h``)
