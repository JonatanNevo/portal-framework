...
.. _program_listing_file_portal_input_input_manager.cpp:

Program Listing for File input_manager.cpp
==========================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_input_input_manager.cpp>` (``portal\input\input_manager.cpp``)
