...
.. _program_listing_file_portal_serialization_archive.cpp:

Program Listing for File archive.cpp
====================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_serialization_archive.cpp>` (``portal\serialization\archive.cpp``)
