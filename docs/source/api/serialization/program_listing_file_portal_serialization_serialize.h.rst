...
.. _program_listing_file_portal_serialization_serialize.h:

Program Listing for File serialize.h
====================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_serialization_serialize.h>` (``portal\serialization\serialize.h``)
