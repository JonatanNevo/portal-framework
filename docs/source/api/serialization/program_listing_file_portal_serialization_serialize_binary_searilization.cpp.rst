...
.. _program_listing_file_portal_serialization_serialize_binary_searilization.cpp:

Program Listing for File binary_searilization.cpp
=================================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_serialization_serialize_binary_searilization.cpp>` (``portal\serialization\serialize\binary_searilization.cpp``)
