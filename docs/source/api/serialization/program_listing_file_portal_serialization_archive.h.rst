...
.. _program_listing_file_portal_serialization_archive.h:

Program Listing for File archive.h
==================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_serialization_archive.h>` (``portal\serialization\archive.h``)
