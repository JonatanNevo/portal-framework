...
.. _program_listing_file_portal_application_modules_base_module.h:

Program Listing for File base_module.h
======================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_application_modules_base_module.h>` (``portal\application\modules\base_module.h``)
