...
.. _program_listing_file_portal_application_application.cpp:

Program Listing for File application.cpp
========================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_application_application.cpp>` (``portal\application\application.cpp``)
