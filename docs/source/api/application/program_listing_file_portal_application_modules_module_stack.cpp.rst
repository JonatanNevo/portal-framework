...
.. _program_listing_file_portal_application_modules_module_stack.cpp:

Program Listing for File module_stack.cpp
=========================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_application_modules_module_stack.cpp>` (``portal\application\modules\module_stack.cpp``)
