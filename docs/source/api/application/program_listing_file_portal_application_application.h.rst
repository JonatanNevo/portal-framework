...
.. _program_listing_file_portal_application_application.h:

Program Listing for File application.h
======================================

|exhale_lsh| :ref:`Return to documentation for file <file_portal_application_application.h>` (``portal\application\application.h``)
