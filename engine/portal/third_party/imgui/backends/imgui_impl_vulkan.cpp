// This was added due to static vulkan linking limitation from the vcpkg port
// source: https://github.com/ocornut/imgui/blob/v1.92.5-docking/backends/imgui_impl_vulkan.cpp
