...
#include "portal/engine/renderer/base/vulkan_resource.h"

namespace portal::vulkan::allocation
{
 ...
 */
void init(const vk::raii::Instance& instance, const vk::raii::PhysicalDevice& physical_device, const vk::raii::Device& device);
