...
private:
    ...
    void process_constant_buffer_parameter(ShaderReflection& reflection, const char* name, slang::TypeLayoutReflection* type_layout, int space, size_t binding_index);
    void process_parameter_block_parameter(ShaderReflection& reflection, const char* name, slang::TypeLayoutReflection* type_layout, int space, size_t binding_index);
    void process_combined_texture_sampler_parameter(ShaderReflection& reflection, const char* name, slang::TypeLayoutReflection* type_layout, int space, size_t binding_index, unsigned int base_shape) const;
    void process_resource_parameter(ShaderReflection& reflection, const char* name, slang::TypeLayoutReflection* type_layout, int space, size_t binding_index, unsigned int resource_shape);
    ...
    void process_buffer_uniforms(shader_reflection::BufferDescriptor& buffer, slang::TypeLayoutReflection* type_layout, StringId buffer_name, size_t buffer_offset);
