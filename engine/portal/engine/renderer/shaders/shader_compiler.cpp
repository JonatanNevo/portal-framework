...
#undef CASE
    ...
    void ShaderCompiler::process_constant_buffer_parameter(ShaderReflection& reflection, const char* name, slang::TypeLayoutReflection* type_layout, int space, size_t binding_index)
    {
    ...
    void ShaderCompiler::process_parameter_block_parameter(ShaderReflection& reflection, const char* name, slang::TypeLayoutReflection* type_layout, int space, size_t binding_index)
    {
    ...
    void ShaderCompiler::process_combined_texture_sampler_parameter(ShaderReflection& reflection, const char* name, slang::TypeLayoutReflection* type_layout, int space, size_t binding_index, unsigned int base_shape) const
    {
        const auto descriptor_set = static_cast<size_t>(space);
    ...
    void ShaderCompiler::process_resource_parameter(ShaderReflection& reflection, const char* name, slang::TypeLayoutReflection* type_layout, int space, size_t binding_index, unsigned int resource_shape)
    {
    ...
    void ShaderCompiler::process_push_constant_parameter(ShaderReflection& reflection, const char* name, slang::TypeLayoutReflection* type_layout, size_t offset)
    {
